...
def get_length_multiplier():
    ...
    tk.Label(root, text="Select length value (e.g. 3 - 4):").pack()
    entry = tk.Entry(root)
    entry.pack()
...
def main():
    ...
    # REPLACED input() WITH TKINTER
    length_value_multiplier = get_length_multiplier()

    if length_value_multiplier != None:
    ...
    if length_selected:
        while True:
            ...
            # (optional but useful) X button fix
